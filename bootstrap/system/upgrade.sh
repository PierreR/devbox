...
nix-channel --update
sudo bash -c "curl http://stash.cirb.lan/projects/CICD/repos/devbox/raw/bootstrap/nixbox/scripts/configuration.nix?at=refs%2Fheads%2F21.05 > /etc/nixos/configuration.nix"
