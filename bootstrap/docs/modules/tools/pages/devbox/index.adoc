...
The box is based on https://nixos.org[NixOS] and make sure any settings can be persisted.
...
https://releases.nixos.org/nixos/20.09/nixos-20.09.1469.13d0c311e3a/nixexprs.tar.xz nixpkgs <1>
EOF
```
