...
Given the personal settings defined in the https://github.com/CIRB/devbox/blob/master/user/params.sh[user/params.sh] file, `vagrant provision --provision-with user` will:
