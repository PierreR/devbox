...
- Virtualbox 5.1.x (tested with 5.1.26)
...
```
mkdir config
curl -o config/box.dhall https://raw.githubusercontent.com/CIRB/devbox/3.4.2/user/config/box.dhall
curl -o config/shell.dhall https://raw.githubusercontent.com/CIRB/devbox/3.4.2/user/config/shell.dhall
```
+
...
image::layout-indicator.png[float="right"]
