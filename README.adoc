...
The current layout is displayed on the status bar.
|=====
|Symbol |Name
...
TIP: You can also change layout by clicking on the symbol
...
|kbd:[<Control><Shift> +/-/=] |Increase/Decrease/Reset font size
