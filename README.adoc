...
```
mkdir config
curl -o config/box https://raw.githubusercontent.com/CIRB/devbox/master/user/config/box.dhall
curl -o config/shell https://raw.githubusercontent.com/CIRB/devbox/master/user/config/shell.dhall
```
+
