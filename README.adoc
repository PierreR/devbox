...
```
mkdir config
curl -o config/box https://raw.githubusercontent.com/CIRB/devbox/3.4.2/user/config/box.dhall
curl -o config/shell https://raw.githubusercontent.com/CIRB/devbox/3.4.2/user/config/shell.dhall
```
+
