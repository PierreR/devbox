...
- install and configure useful packages (eclipse, docker, vim, ...)
- setup your git config
- synchronize the `ssh-keys` folder from the ROOT_DIR
- installed declared `mr` repositories including all https://github.com/CIRB/devbox-dotfiles[dotfiles]
- install the cicd shell
- install all required packages for working with puppet stacks

#### dotfiles

You can install any git repositories including your own personal configuration thanks to a little tool called  https://github.com/RichiH/vcsh[vcsh].
